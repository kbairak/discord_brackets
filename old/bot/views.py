...
class CollectionView(discord.ui.View):
    ...
    @discord.ui.button(label="Submit Contestant", style=discord.ButtonStyle.primary)
    ...
    @discord.ui.button(label="Edit Contestants", style=discord.ButtonStyle.secondary)
    ...
    @discord.ui.button(label="End Collection", style=discord.ButtonStyle.success)
    async def end_collection_button(
...
class RoundControlView(discord.ui.View):
    ...
    @discord.ui.button(label="End Round", style=discord.ButtonStyle.danger)
